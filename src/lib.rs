...
pub use decoder::{
    ...
    parse_tga_postage_stamp, parse_tga_scan_line, parse_tga_scan_line_table, parse_tga_software_id,
...
pub use types::{
    ...
    TGA_FOOTER_MAGIC, TGA_FOOTER_SIZE, TGA_HEADER_SIZE, TGA_SCAN_LINE_OFFSET_BYTES,
};
