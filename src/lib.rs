...
pub use decoder::{
    ...
    parse_tga_author_comments, parse_tga_author_name, parse_tga_color_map,
    parse_tga_colour_correction_table, parse_tga_developer_area, parse_tga_extension_area,
    parse_tga_footer, parse_tga_gamma, parse_tga_image_id, parse_tga_interleaving,
    ...
    parse_tga_timestamp, resolve_alpha_from_descriptor, resolve_alpha_with_targa32_fallback,
};
pub use encoder::{
...
pub use types::{
    ...
    TGA_ASCII_FIELD_MAX_CHARS, TGA_ATTRIBUTE_BITS_MAX, TGA_AUTHOR_COMMENT_LINES,
